...
const TYPED_LINES = [
  "> Yashu",
  "...",
  "> Since I cant buy you a gift",
  "...",
  "> I tried to make this",
  "...",
  "I really hope you like it. HAPPY BIRTHDAYYYY!!!!!۶"
];
  ...
  return (
    <>
      <group ref={tableGroup}>
        <Table />
        <PictureFrame
          image={asset("/frame2.jpg")}
          position={[0, 0.735, 3]}
          rotation={[0, 5.6, 0]}
          scale={0.75}
        />
        <PictureFrame
          image={asset("/frame3.jpg")}
          position={[0, 0.735, -3]}
          rotation={[0, 4.0, 0]}
          scale={0.75}
        />
        <PictureFrame
          image={asset("/frame4.jpg")}
          position={[-1.5, 0.735, 2.5]}
          rotation={[0, 5.4, 0]}
          scale={0.75}
        />
        <PictureFrame
          image={asset("/frame1.jpg")}
          position={[-1.5, 0.735, -2.5]}
          rotation={[0, 4.2, 0]}
          scale={0.75}
        />
...
export default function App() {
  ...
  useEffect(() => {
    const audio = new Audio(asset("/music.mp3"));
    audio.loop = true;
    audio.preload = "auto";
    ...
    <div className="App">
      ...
      >
        <Suspense fallback={null}>
          ...
          <Environment
            files={[asset("/shanghai_bund_4k.hdr")]}
